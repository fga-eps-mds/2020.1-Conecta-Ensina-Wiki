...
const siteConfig = {
  ...
  baseUrl: '/2020.1-Conecta-Ensina-Wiki/', // Base URL for your project */
  // For github.io type URLs, you would set the url and baseUrl like:
  //   url: 'https://facebook.github.io',
  //   baseUrl: '/test-site/',

  // Used for publishing and more
  projectName: '2020.1-Conecta-Ensina-Wiki',
  ...
  headerIcon: 'img/conecta_logo.ico',
  footerIcon: 'img/favicon.ico',
  favicon: 'img/conecta_logo.ico',

  /* Colors for website */
  colors: {
    primaryColor: '#428df5',
    secondaryColor: '#0000f5',
  },
  ...
  */
  ...
  copyright: `Copyright © ${new Date().getFullYear()} Conecta Ensina`,
